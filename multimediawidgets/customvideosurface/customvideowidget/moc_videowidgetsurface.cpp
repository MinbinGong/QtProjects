...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoWidgetSurface_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject VideoWidgetSurface::staticMetaObject = { {
    &QAbstractVideoSurface::staticMetaObject,
    qt_meta_stringdata_VideoWidgetSurface.data,
    qt_meta_data_VideoWidgetSurface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VideoWidgetSurface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoWidgetSurface.stringdata0))
